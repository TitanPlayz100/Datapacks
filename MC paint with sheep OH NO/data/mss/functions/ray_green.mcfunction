...
execute if score @s stop_ray matches 1.. if block ~ ~ ~ air positioned ~ ~-1.35 ~ unless entity @e[distance=..0.75,type=!minecraft:armor_stand,type=!item_frame,type=!player] positioned ^ ^ ^1 positioned ~ ~1.35 ~ run function mss:ray_green
