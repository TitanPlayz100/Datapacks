...
execute as @a[tag=d,limit=1] at @s run summon minecraft:armor_stand ~ ~ ~ {Invisible:1b,CustomName:'{"text":"d"}'}
execute as @a[tag=e,limit=1] at @s run summon minecraft:armor_stand ~ ~ ~ {Invisible:1b,CustomName:'{"text":"e"}'}
...
tp @a[tag=c,limit=1] @e[type=minecraft:armor_stand,limit=1,name=d]
tp @a[tag=d,limit=1] @e[type=minecraft:armor_stand,limit=1,name=e]
tp @a[tag=e,limit=1] @e[type=minecraft:armor_stand,limit=1,name=a]
