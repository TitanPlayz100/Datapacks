...
execute if entity @s[tag=!rng_src,scores={random=0..}] run function crypto:randomiser/alg
execute if entity @s[tag=!rng_src,scores={random=1..}] unless score @s random_limit = @s random if score @s random_data < @s random_limit run function crypto:randomiser/generate
